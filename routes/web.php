...
Route::delete('/bands/{id}', [BandController::class, 'destroy'])->middleware('auth')->name('bands.destroy');
...
Route::delete('/albums/{id}', [AlbumController::class, 'destroy'])->middleware('auth')->name('albums.destroy');
